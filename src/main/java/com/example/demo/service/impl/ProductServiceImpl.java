...
import com.example.demo.model.request.CreateSizeCountRequest;
import com.example.demo.model.request.FilterProductRequest;
import com.example.demo.model.request.UpdateFeedBackRequest;
...
import static com.example.demo.utils.Contant.*;
...
public class ProductServiceImpl implements ProductService {
    ...
    public DetailProductInfoDTO getDetailProductById(String id) {
        ...
        dto.setPageNumber(product.getPageNumber());
        ...
        if (promotion != null) {
            ...
            usedPromotion.setCouponCode(dto.getCouponCode());
            usedPromotion.setDiscountValue(dto.getPromotionPrice());
        } else {
            dto.setCouponCode("");
        }
        return dto;
